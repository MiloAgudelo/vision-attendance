...
Fase 5 / **W6 estabilización**: e2e del flujo completo con el simulador (enrolar → escanear → en
vivo → corregir → auditar); matriz del alcance (duplicados, atrasados, revocado, reasignación de
carnet); revisión de seguridad (RLS deny-all, secretos, rate-limit básico); README/docs finales y
